...
# make this program run faster using a technique introduced in lecture - 
# bisection search!
...
def bisectionPaymentSearch(balance, annualInterestRate, lower = 0, upper = 0):
    ...
    lower : float or int, default 0
    upper : float or int, default 0

    Returns : float, smallest monthly payment to pay off debt in a year
    '''
...
print(bisectionPaymentSearch(balance, annualInterestRate))